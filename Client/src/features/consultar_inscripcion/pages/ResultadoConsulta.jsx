            ...
            <div className="resultado-container">
                ...
                <div className="resultado-content">
                    <div className="error-message">
                        ...
                        <button onClick={() => navigate('/consultar-inscripcion')}>
                            Volver a consultar
                        </button>
                    </div>
                </div>
                            ...
                            {olimpistas.map((olimpista) => {
                                ...
                                return (
                                    <tr key={olimpista.idInscripcion}>
                                        ...
                                        <td className={olimpista.estadoPago === 'PAGO PENDIENTE' ? 'estado-pendiente' : 'estado-realizado'}>
                                    ...
                                    <tbody>
                                        {Array.isArray(inscripciones) && inscripciones.length > 0 ? (
                                            inscripciones.map((inscripcion, index) => (
                                                <tr key={index}>
                                                    <td>{inscripcion.olimpiadaAreaCategoria?.area?.nombreArea || 'No disponible'}</td>
                                                    <td>{inscripcion.olimpiadaAreaCategoria?.categoria?.nombreCategoria || 'No disponible'}</td>

                                                    <td>
                                                        {inscripcion.tutorResponsable?.nombre} {inscripcion.tutorResponsable?.apellido}
                                                    </td>
                                                    <td className={inscripcion.estadoInscripcion === 0 ? 'estado-pendiente' : 'estado-realizado'}>
        ...
        return (
            <div className="resultado-container">
                ...
                <div className="resultado-content">
                    ...
                    {resultado?.data?.olimpistas && renderOlimpistasTable(resultado.data.olimpistas)}
