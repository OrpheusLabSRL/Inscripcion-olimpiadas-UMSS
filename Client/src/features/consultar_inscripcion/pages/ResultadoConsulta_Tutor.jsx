            ...
            <div className="resultado-container">
                <div className="resultado-content">
                    ...
                    <div className="tutor-info">
                        ...
                        <p><strong>Carnet de Identidad:</strong> {tutor.carnetIdentidad}</p>
                        <p><strong>Correo Electrónico:</strong> {tutor.correoElectronico}</p>
                            ...
                            <tbody>
                                {olimpistas.map((olimpista) => (
                                    <tr key={olimpista.idInscripcion}>
                                        ...
                                        <td className={`estado-pago ${getEstadoPagoClass(olimpista.estadoPago)}`}>
                    ...
                    <button onClick={() => navigate('/consultar-inscripcion')} className="volver-button">
                        Volver a consultar
                    </button>
                </div>
            </div>
